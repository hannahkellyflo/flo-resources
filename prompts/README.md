...
`resources.joinflo.com/prompts`. A searchable, filterable library of 129 prompts
customers copy into Flo AI. Like the tracker, the page is generated: this
directory is the source, `site/prompts/index.html` is the output.

**Don't hand-edit `site/prompts/index.html`.** Change the inputs here and rebuild:
